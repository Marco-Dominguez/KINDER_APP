...
<body>
    ...
    <form action="personal.php" method="POST">
        ...
        <input type="text" name="staffName" value="<?= $editingStaff ? htmlspecialchars($editingStaff['maestra_per']) : '' ?>" required><br><br>

        <label>Correo Electrónico:</label><br>
        <input type="email" name="staffEmail" value="<?= $editingStaff ? htmlspecialchars($editingStaff['correo_per']) : '' ?>" required><br><br>

        <label>Teléfono Celular:</label><br>
        <input type="tel" name="staffPhone" value="<?= $editingStaff ? htmlspecialchars($editingStaff['cel_per']) : '' ?>" required><br><br>

        <button type="submit"><?= $editingStaff ? 'Actualizar Registro' : 'Guardar Registro' ?></button>
        <?php if ($editingStaff): ?>
            <a href="personal.php" style="margin-left:10px;">Cancelar</a>
        <?php endif; ?>
    </form>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="personal.php?edit=<?= htmlspecialchars($staffMember['id_per']) ?>" style="display:inline-block;margin-bottom:4px;padding:4px 8px;background:#0066cc;color:white;text-decoration:none;border-radius:4px;font-size:0.85em;">Editar</a><br>
